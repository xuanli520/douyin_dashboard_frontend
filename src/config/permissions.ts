...
export const PAGE_PERMISSIONS: RoutePermissionConfig[] = [
  ...
  },
  {
    ...
    requiredPermissions: ['view:admin_users'],
    requiredRoles: ['admin'],
    unauthRedirect: '/login',
    forbiddenRedirect: '/403',
  },
  {
    ...
    requiredPermissions: ['view:admin_roles'],
    requiredRoles: ['admin'],
    unauthRedirect: '/login',
    forbiddenRedirect: '/403',
  },
  {
    ...
    requiredPermissions: ['view:admin_permissions'],
    requiredRoles: ['admin'],
    unauthRedirect: '/login',
    forbiddenRedirect: '/403',
  },
  {
    ...
    requiredPermissions: ['view:admin_login_audit'],
    requiredRoles: ['admin'],
    unauthRedirect: '/login',
    forbiddenRedirect: '/403',
  },
  ...
  },
  {
    ...
    requiredPermissions: ['view:system_settings'],
    requiredRoles: ['admin'],
    unauthRedirect: '/login',
    forbiddenRedirect: '/403',
  },
